import { AutomationIcon, BrandingIcon } from "@/components/brand-icons";
    ...
    <section className="bd-section">
      <div className="bd-container grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        ...
        <SectionReveal delay={0.1} className="grid gap-4">
          <div className="bd-glass-card p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="bd-hover-lift rounded-bd border border-bd-border bg-bd-elevated/70 p-5">
              <BrandingIcon className="mb-4 h-10 w-10" />
            ...
            <div className="bd-hover-lift rounded-bd border border-bd-border bg-bd-elevated/70 p-5">
              <AutomationIcon className="mb-4 h-10 w-10" />
